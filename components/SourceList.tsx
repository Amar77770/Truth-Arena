...
const SourceList: React.FC<SourceListProps> = ({ sources }) => {
  return (
    <div className="mt-6 bg-[#0a0a0a] border-2 border-green-800 p-6 font-mono relative shadow-[0_0_20px_rgba(20,83,45,0.2)]">
      <div className="absolute -top-3 left-4 bg-black px-2 text-green-500 font-arcade text-xs border border-green-800 shadow-[0_0_10px_rgba(0,255,0,0.3)]">
        CHEAT CODES (SOURCES)
      </div>
      ...
      {sources.length === 0 ? (
          <div className="text-center py-6">
              ...
              <p className="font-mono text-xs text-gray-700 italic">
                  The analysis was generated using internal logic models. 
                  <br/>External signal triangulation failed or was not required.
              </p>
          </div>
      ) : (
              ...
              <li key={index} className="group relative">
                ...
                >
                  ...
                  <div className="flex-1 relative z-10">
                      <div className="text-sm text-green-600 group-hover:text-green-300 font-bold transition-all break-all group-hover:tracking-wide">
